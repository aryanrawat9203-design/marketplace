  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
      ...
      <div className={`relative mt-4 overflow-hidden rounded-2xl bg-gradient-to-br ${c.gradient} p-[1px]`}>
        <div className="relative rounded-[15px] bg-[#0b0b12] p-6 sm:p-8">
          <div
            aria-hidden="true"
          ...
          <div className="mt-5 flex flex-wrap items-baseline gap-x-4 gap-y-1">
            <span className="font-display text-2xl font-bold tracking-tight text-zinc-50">{inr(stats.price)}</span>
